                  ...
                  <ul class="dropdown smsEmail">
                     ...
                     <li class="dib fr">
                        ...
                        <div id="sendEmail" class="fancybox-content" style="display:none;width:100%;max-width:340px;border-radius:20px;overflow: visible;">
                           <form name="email_form" method="post" action="http://catalog.realestateindia.com/catalog-enquiry.php" >
                              ...
                              <div class="sendEnq mt15px">
                                 ...
                                 <div id="footerprd_10021_display_alert">
                                    ...
                                    <input type="hidden" name="current_url" value="index.html"> <input type="hidden" name="web_address" value="index.html"> <input type="hidden" name="inq_thanks_msg" value="Thank you for inquiry.&lt;br /&gt;&lt;br /&gt;We have received your business request. Our Sales Team will soon get in touch with you.&lt;br /&gt;&lt;br /&gt;&lt;br /&gt;"><input type="hidden" name="inq_thanks_title" value="Enquiry"> <input type="hidden" name="redirected_url" value="thanks.html"><input type="hidden" name="catalog_mi" value="88260"> <input type="hidden" name="id" value="static_form"> <input type="hidden" name="form_id" value="10021">
                                 </div>
                              </div>
                           </form>
                        </div>
