                  ...
                  <div class="col-2 wideColumn ip ls">
                     ...
                     <div class="bdr br5px mt20px pr ofh">
                        <div class="p15px data bdr0 bdrB">
                           <p class="large mb10px lh12em">Review by SHIV PRASAD DAS</p>
                           <p class="ac-dib acac-dib ac-mr5px lc-mr0 mb15px">
                              <span class="vam xxlarge dif" style="">
                           ...
                           <p class="lh14em i large">Highly professional in their job…go the extra mile in securing the best property in Phase 7, Mohali</p>
                        </div>
                     </div>
                     <a id="150361"></a>
                     <div class="bdr br5px mt20px pr ofh">
                        <div class="p15px data bdr0 bdrB">
                           <p class="large mb10px lh12em">Review by Jignesh</p>
                           <p class="ac-dib acac-dib ac-mr5px lc-mr0 mb15px">
                              <span class="vam xxlarge dif" style="">
                              <i class="fa fa-star mr2px"></i>
                              <i class="fa fa-star mr2px"></i>
                           ...
                           <p class="lh14em i large">I was shifted to the new city for my job purpose and wanted to get a property on rent or as a paying guest. I am thankful to this real estate agent for helping me reaching out to the reliable lessors or renters. I got my rented flat at a very affordable rent and at the exact location in which I wanted.</p>
                        </div>
                     </div>
                     <a id="150362"></a>
                     <div class="bdr br5px mt20px pr ofh">
                        <div class="p15px data bdr0 bdrB">
                           <p class="large mb10px lh12em">Review by Shiva</p>
                           <p class="ac-dib acac-dib ac-mr5px lc-mr0 mb15px">
                              <span class="vam xxlarge dif" style="">
                              <i class="fa fa-star mr2px"></i>
                              <i class="fa fa-star mr2px"></i>
                           ...
                           <p class="lh14em i large">I shared my requirements related to the properties I wanted to rent with this real estate agent. Soon, I started receiving a number of queries from interested tenants within a few weeks. All thanks to this agent that I got reliable tenants today. I would like to recommend this agent to everyone.</p>
                        </div>
                     </div>
                     <a id="150363"></a>
                     <div class="bdr br5px mt20px pr ofh">
                        <div class="p15px data bdr0 bdrB">
                           <p class="large mb10px lh12em">Review by Anup</p>
                           <p class="ac-dib acac-dib ac-mr5px lc-mr0 mb15px">
                              <span class="vam xxlarge dif" style="">
                              <i class="fa fa-star mr2px"></i>
                              <i class="fa fa-star mr2px"></i>
                           ...
                           <p class="lh14em i large">Owing to the high competition in the real estate sector, I got very confused as I have contacted different agents. At last, I came in contact with this real estate agent and stick with them as they have immense knowledge and offer surprising suggestions for the real estate investment. This was certainly one of the best decisions that I made.</p>
                        </div>
                     </div>
                     <br>
                     <a id="post"></a>
                     <p class="ac"><a href="javascript:void(0)" class="testbtn dib p10px20px c5px xxlarge" id="postYourTestimonialButton" onclick="jQuery('#postYourTestimonialButton').slideUp('slow');jQuery('#postYourTestimonial').slideDown('fast');">Post Your Testimonials</a></p>
                     <div id="postYourTestimonial"  style="display:none;">
                        <form name="testimonial" method="post" action="http://catalog.realestateindia.com/catalog-testimonials-submit.php" onsubmit="return validate_form();" enctype="multipart/form-data">
                              ...
                              <table class="w100 ffg large formTable">
                                 ...
                                 <tr>
                                    ...
                                    <td class="p7px">
                                       ...
                                       <input type="hidden" value="88260" name="mem_id" />
                                       <input type="hidden" value="https://www.chandigarhhouse.com/testimonials.htm" name="redirected_url" />
                                    </td>
                                 </tr>
                              </table>
                           </div>
                     ...
                     <script>
                        function validate_form(){
                        	...
                        	if(reg.test(document.testimonial.email_id.value) == false) {
